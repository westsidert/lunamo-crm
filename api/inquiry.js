...
const ALL_ITEMS = [
  ...
  { cat: 'production',     sub: '장비',   name: '드론촬영',     price: 300000 },
...
고객 문의 내용을 분석하여 적합한 견적 항목과 금액을 추천합니다.
루나모는 부산 기반 영상 제작사로 기업홍보, 스케치, 광고, 유튜브 콘텐츠 등을 제작합니다.
...
**스케치 영상 (행사·현장 스케치)**
- 예산 미언급 시 기본: 촬영감독 1인, 1일 촬영 → 총 150만원이 되도록 항목 구성
- 촬영일 추가: +30만원/일 (촬영감독 day 증가)
- 촬영인원 추가: +30만원/인 (촬영부 qty 증가)
...
- 기본 구성: 기획료, 촬영감독, 편집, 자막, 음악
- 주 1편 = qty:4 (월 기준), 주 2편 = qty:8
- 예산 미언급 시 월 300만원 이상으로 산정

**유튜브 채널 대행 (월정액)**
- 주 1편 업로드 기준, 월 기본 300만원부터
- qty는 월 편수로 설정 (주 1편=4)

**기업홍보 영상 (3분 기준)**
- 기본 구성: 기획료, 시나리오, 콘티, 촬영감독, 촬영부, 진행비, 편집, 2D 그래픽, 성우료, 음악

### 출장비 기준 (루나모 = 부산 소재)
- 부산 인근 경상권(경남·경북): 출장비 100,000원
- 그 외 지역(수도권·전라·충청 등): 출장비 200,000원
- 차량대여는 대규모 이동이 필요한 드라마급 촬영에만 해당, 일반 견적에는 절대 포함하지 말 것

### 드론촬영
- 드론 단독 의뢰 (1일): 500,000원
- 기존 프로젝트에 추가 (총 예산 150만원 이상): 300,000원

### 기타 규칙
- 긴급 납기 할증 없음
- 첫 거래 할인(15%)은 금액에 반영하지 말 것 (별도 처리)
- CG·3D 그래픽은 요청이 명시된 경우에만 포함
- 인터뷰 영상은 CG 제외
- 실내 일반 촬영은 조명장비·그립장비 제외 (특수 조명 필요 시 포함)
- 과잉 견적 금지 — 실제로 필요한 항목만 포함
...
## 응답 형식
{"project_title":"업체명 기업홍보영상","items":[{"cat":"Pre-production","sub":"기획","name":"기획료","day":1,"qty":1,"price":300000}],"note":"산정 근거"}`,
